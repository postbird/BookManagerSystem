   ...
   <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php if(is_array($notices)): $i = 0; $__LIST__ = $notices;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$notice): $mod = ($i % 2 );++$i;?><a href="/BookManagerSystem/Home/Index/notice/view/<?php echo ($notice["guid"]); ?>">
                            <div >
                                <p>
