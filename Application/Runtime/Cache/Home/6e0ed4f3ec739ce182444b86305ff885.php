      ...
      <div class="container-fluid no-padding-left">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav" >
                ...
                <li><a href="/BookManagerSystem/Home/Admin/comment">留言</a></li>
              </ul>
			...
			<div class="panel panel-info">
				...
				<?php if(is_array($comments)): $i = 0; $__LIST__ = $comments;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$comment): $mod = ($i % 2 );++$i;?><div class="list-group-item">
                        <p>
                        	...
                        	<?php if($comment["ischeck"] == 1): ?><span class="red-font">&nbsp;&nbsp; 未审核</span>
							<?php else: ?>
								<span class="text-primary">&nbsp;&nbsp;已经审核</span><?php endif; ?>
                    	</p>
                        <p class="text-indent"><?php echo ($comment["content"]); ?></p>
                        <p class="text-right">
							<?php if($comment["ischeck"] == 1): ?><a href="/BookManagerSystem/Home/Admin/check/comment/<?php echo ($comment["guid"]); ?>"class="btn btn-info btn-xs"><i class="fa fa-check"></i></a>
								<a href="/BookManagerSystem/Home/Admin/delete/comment/<?php echo ($comment["guid"]); ?>"class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
							<?php else: ?>
								...
								<a href="/BookManagerSystem/Home/Admin/delete/comment/<?php echo ($comment["guid"]); ?>"class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a><?php endif; ?>
